            ...
            return (
              ...
              >
                <View
                  ...
                  className="w-9 h-9 rounded-xl items-center justify-center shrink-0 mt-[1px]"
                >
                  <View
                ...
                <View className="flex-1">
                  <View className="flex-row justify-between items-baseline">
                    <Text
                      className={`text-[14px] tracking-[-0.2px] flex-1 ${
                        n.isRead
                    ...
                    <Text className="text-[12px] text-quaternary shrink-0 ml-2">
                      {timeAgo(n.createdAt)}
                    </Text>
                  </View>
                  <Text className="text-[13px] text-secondary leading-[18px] tracking-[-0.1px] mt-[3px]">
                    {n.body}
                  </Text>
                </View>
              </Pressable>
